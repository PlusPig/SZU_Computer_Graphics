...
void display()
{
	...
	float y_plane = 0.0f;
	float lx = light_position.x, ly = light_position.y, lz = light_position.z;
	...
	shadowMat = shadowMat / ly;

	glm::mat4 shadowModelMatrix = shadowMat * triangle->getModelMatrix();
	// 传递 isShadow 变量。
...
int main(int argc, char **argv)
{
	...
	GLFWwindow *mainwindow = glfwCreateWindow(600, 600, "2023152019_朱政灏_lab3.2", NULL, NULL);
	if (mainwindow == NULL)
	{
